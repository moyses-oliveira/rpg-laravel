...
<div class="container-fluid px-3 py-3" style="height:calc(100vh - 48px)">
    <div class="app-shell">
        <aside class="left-panel">
            ...
            <div class="char-stat d-flex align-items-center"><div class="char-avatar">V</div><div><strong>Valen</strong><br><small>Elfo Druida</small></div></div>
            <p class="small text-muted mb-1"><i class="fa-solid fa-heart text-danger me-1"></i> Vida: <span class="text-white">85 / 100</span></p>
            <div class="progress mb-2" style="height:4px;"><div class="progress-bar bg-danger" style="width:85%"></div></div>
            <p class="small text-muted mb-1"><i class="fa-solid fa-droplet text-info me-1"></i> Mana: <span class="text-white">50 / 70</span></p>
            <div class="progress mb-3" style="height:4px;"><div class="progress-bar bg-info" style="width:70%"></div></div>
            <p class="small">Equipamento: Cajado da Floresta<br>Habilidade: Cura Natural</p>
        </aside>
